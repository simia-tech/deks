...
func TestStoreSetNewValue(t *testing.T) {
	...
	assert.Equal(t, []kea.Item{{0xa6, 0x2f, 0x22, 0x25, 0xbf, 0x70, 0xbf, 0xac, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0}}, e.storeOne.State().Items())
}
...
func TestStoreSetExistingValue(t *testing.T) {
	...
	assert.Equal(t, 1, e.storeOne.Len())
	require.Equal(t, 1, e.storeOne.State().Len())
	assert.Equal(t, []kea.Item{{0xa6, 0x2f, 0x22, 0x25, 0xbf, 0x70, 0xbf, 0xac, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1}}, e.storeOne.State().Items())
}
...
func TestStoreSetDeletedValue(t *testing.T) {
	...
	assert.Equal(t, 1, e.storeOne.Len())
	require.Equal(t, 1, e.storeOne.State().Len())
	assert.Equal(t, []kea.Item{{0xa6, 0x2f, 0x22, 0x25, 0xbf, 0x70, 0xbf, 0xac, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2}}, e.storeOne.State().Items())
}
